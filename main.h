...
/**
 * struct specifiers - format structure
 *
 * @format_char: The format.
 * @format_function: The function associated.
*/
...
int handle_print(const char *fmt, int *i, va_list list,
	char buffer[], int flags, int width, int precision, int length);
